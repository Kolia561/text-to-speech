...
//objetos:
//      audioPlayer --> se crea cuando se agrega la escucha de evento en ('DOMContentLoaded')
//      currentAudioUrl
//funciones:
//
...
//
//addEventListener:
//  Crea e inicializa el audioPlayer, carga las configuraciones guardadas
//
...
document.addEventListener('DOMContentLoaded', async function() {
  ...
  audioPlayer = new window.AudioPlayer(); //agregue window.
  ...
  // Download button. Se le agrega la escucha de evento configurado en click.
  // Al clickear chequea la url del audio actual crea una elemento 'a' en el documento
  // le agrega el URl al href y el .mp3 al download agrega el 'a' al body, lo clickea y elimina el 'a' del body.
  // por ultimo actualiza el estado.
