...
config.settings = {
  ...
  set ttsEngine (val) {app.storage.write("ttsEngine", val)},
  set localServerUrl (val) {app.storage.write("localServerUrl", val)},
  ...
  get ttsEngine () {return (app.storage.read("ttsEngine") !== undefined ? app.storage.read("ttsEngine") : "edgetts")},
  get localServerUrl () {return (app.storage.read("localServerUrl") !== undefined ? app.storage.read("localServerUrl") : "http://localhost:8000")},
